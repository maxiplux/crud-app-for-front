...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:4200","https://frontbase-angular-production.up.railway.app","http://localhost","http://frontbase-angular-production.up.railway.app"));
